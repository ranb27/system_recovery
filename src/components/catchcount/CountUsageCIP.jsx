...
export default function CountUsageCIP() {
  const systemName = "Smart IT Management";
  const menuName = "Computer In Process";
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data && res.data.length > 0 && res.data[0].user_login) {
          ...
          const getDataCountLocal = localStorage.getItem("getDataCount_ITM");
